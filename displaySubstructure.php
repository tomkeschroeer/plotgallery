    ...
    <?php
      ...
      // display all non-hidden directories
        if(!in_array($file, $ignore)) {
          ...
          if($file=="Split_histograms") {
            $displayPath = "displaySubstructureSplit.php?collection=" . $file . "&dir=" . $collection . "&sample=" . $sample;
          }
          else {
            $displayPath = "displayGallery.php?collection=" . $file . "&dir=" . $collection; 
          }
        ...
        echo "<h4>".date("F d Y", filectime("content/".$collection))."</h4>\n";
